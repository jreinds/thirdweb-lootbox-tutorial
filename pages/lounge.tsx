...
export default function Lounge() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div>
        <h2 className="text-4xl font-bold">NFT and crypto alfa</h2>
        <p>It's always been Bitcoin 🤫</p>
        <p>A coin like no other. Programmability is cool but Bitcoin has a stronger meme game.</p>
      </div>
    </div>
  )
}
